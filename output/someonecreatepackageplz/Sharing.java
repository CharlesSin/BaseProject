...
public class Sharing {
  ...
  public void sharing(int com) {
    ...
    if (Integer.parseInt(decode) == 0) {
      Main.getInstance().addPost("Where do you want to share your result?", "", "List :", "", "A: Facebook",
          "B: Instagram", "C: Twitter", "D: QQ", "E: VKontakte", "F: Google+");
          ...
          Desktop.getDesktop().browse(new URI(com == 1 ? "https://www.facebook.com/"
              : com == 2 ? "https://www.instagram.com/"
                  : com == 3 ? "https://twitter.com/"
                      : com == 4 ? "http://qzone.qq.com/" : com == 5 ? "https://vk.com/" : "https://plus.google.com/"));
        } catch (IOException e) {
      ...
      list.add(Main.getInstance().Gather.getTotal() < 200 ? "Please Go To Work, Because your study result is to bad."
          : "Please When To High School STUDY HARD!!!");
      list.add("=========================================");
